...
export default function MyKeyboard() {
  ...
  const getKeyboardBackgroundColor = () => {
    return {
      backgroundColor: theme === 'claro' ? 'lightblue' : '#274c64', 
  ...
  return (
    <View style={Styles.viewBottom}>
      ...
      {/* view que envuelve el teclado */}
      <View style={[Styles.keyboardContainer, getKeyboardBackgroundColor()]}>
        <View style={Styles.row}>
          <Boton titulo="C" alPresionar={limpiar} />
          <Boton
            titulo="+/-"
          ...
          <Boton
            ...
            alPresionar={() => handlePresionarOperacion("％")}
          />
          <Boton titulo="÷" alPresionar={() => handlePresionarOperacion("/")} />
        </View>
        <View style={Styles.row}>
        ...
        <View style={Styles.row}>
          ...
          />
          <Boton titulo="="  alPresionar={() => getResult()} />
        </View>
      </View>
    </View>
  );
